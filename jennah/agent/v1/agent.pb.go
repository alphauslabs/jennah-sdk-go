...
type AgentInstance struct {
	...
	Region          string                 `protobuf:"bytes,4,opt,name=region,proto3" json:"region,omitempty"` // location id this workspace is pinned to, e.g. "us-east-1" (see PlatformService.ListLocations)
